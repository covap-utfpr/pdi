...
(ref:componente_conexa) Componentes Conexos de uma imagem bidimensional [@pedrini2008, p. 32].

```{r componente_conexa, echo=FALSE, fig.asp=.7, fig.width= 4, fig.cap='(ref:componente_conexa)', fig.align='center', out.width='20%'}
