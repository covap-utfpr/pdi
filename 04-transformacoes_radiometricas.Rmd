...
(ref:potencial) Transformações de potência. (a) Imagem aérea. (b) a (d) Resultados da aplicação da transformação de potência com $c = 1 \text{ e } γ = 3, 4 \text{ e } 5$, respectivamente. [@gonzalez2010, p. 74].
