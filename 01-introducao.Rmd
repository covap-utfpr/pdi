...
knitr::include_graphics(rep('imagem/areasPDI.png'))
...
knitr::include_graphics(rep('imagem/espectro.png'))
```
...
knitr::include_graphics(rep('imagem/aplicacoes.png'))
```
...
knitr::include_graphics(rep('imagem/etapasPDI.png'))
```
...
knitr::include_graphics(rep('imagem/aquisicao.png'))
```
...
knitr::include_graphics(rep('imagem/preProcessamento.png'))
```
...
knitr::include_graphics(rep('imagem/segmentacao.png'))
```
...
knitr::include_graphics(rep('imagem/analise.png'))
```
